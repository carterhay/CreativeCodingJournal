...
return (new CustomEvent(event_name,(function (){var obj31123 = ({"detail":data});
return obj31123;
})()));
} else {
...
var f = (function (){var pred__31130 = cljs.core._EQ_;
var expr__31131 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31130.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31131))){
return ((function (pred__31130,expr__31131){
return (function (p1__31124_SHARP_){
return console.warn(p1__31124_SHARP_);
});
;})(pred__31130,expr__31131))
} else {
if(cljs.core.truth_(pred__31130.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31131))){
return ((function (pred__31130,expr__31131){
return (function (p1__31125_SHARP_){
return console.debug(p1__31125_SHARP_);
});
;})(pred__31130,expr__31131))
} else {
if(cljs.core.truth_(pred__31130.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31131))){
return ((function (pred__31130,expr__31131){
return (function (p1__31126_SHARP_){
return console.error(p1__31126_SHARP_);
});
;})(pred__31130,expr__31131))
} else {
return ((function (pred__31130,expr__31131){
return (function (p1__31127_SHARP_){
return console.log(p1__31127_SHARP_);
});
;})(pred__31130,expr__31131))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31134){
...
var opts = map__31135__$1;
var eval_fn = cljs.core.get.call(null,map__31135__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31137_SHARP_);
});})(new_def))
);
...
return (function (p__31138){
var vec__31139 = p__31138;
var ky = cljs.core.nth.call(null,vec__31139,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1651840304256
